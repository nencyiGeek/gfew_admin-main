...
const Poll = lazy(() => import("./views/poll/index"))
const CommanFieldPoll = lazy(() => import("./views/poll/createPoll"))
const commentDetails = lazy(() => import("./views/poll/commentDetails"))
const challenge =   lazy(() => import("./views/challenge"))
const ChallengeDashboard =   lazy(() => import("./views/challengeDashboard/ChallengeDashboard"))
...
const VerifyMail = lazy(() => import("./views/verifyMail"))
const users = lazy(() => import("./views/users"))
const createProfile = lazy (() => import("./views/CreateProfile/ProfileTodo"))
    ...
    return (
      <Router history={history}>
        ...
        <Switch>
          ...
          <AppRoute path="/forgetPassword" component={forgotPassword} fullLayout />
          <AppRoute path="/verify-mail/:token" component={VerifyMail} fullLayout />
          <AppRoute path="/profile" component={profile} />
          { isProfileCreated ? 
            <AppRoute path="/createProfile" component={createProfile}  
          /> :<AppRoute path="/createProfile" component={createProfile} fullLayout/>}
          <AppRoute
            path="/todo"
            exact
         ...
         <AppRoute
          ...
          <AppRoute path="/challenge/dashboard" component={ChallengeDashboard} />
          <AppRoute path="/challenge" component={challenge} />
          ...
          <AppRoute
            ...
            component={() => <Redirect to="/todo/all" />}
          />
          <AppRoute path="/createpoll" component={CommanFieldPoll} />
          <AppRoute path="/poll" component={Poll} />
          <AppRoute path="/createpoll/:id" component={Poll} />
          <AppRoute path="/todo/:filter" component={todo} />
          <AppRoute path="/calendar" component={calendar} />
          <AppRoute path="/ecommerce/shop" component={shop} />
          <AppRoute path="/ecommerce/wishlist" component={wishlist} />
          <AppRoute path="/commentDetails" component={commentDetails} />
          {/* <AppRoute
          ...
          <AppRoute
            ...
            fullLayout
          />
          <AppRoute path="/user" component={users} />
          <AppRoute path="/app/user/list" component={userList} />
          <AppRoute path="/app/user/edit" component={userEdit} />
          <AppRoute path="/app/user/view" component={userView} />
